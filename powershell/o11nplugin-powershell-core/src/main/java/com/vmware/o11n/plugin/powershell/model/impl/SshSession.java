...
public class SshSession extends BaseSession {

    private static final long serialVersionUID = 1L;

    public SshSession(String host, String username, String password, BasePowerShellTerminal psTerminal) throws PowerShellException {
