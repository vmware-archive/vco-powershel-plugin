...
public class WinRmSession extends BaseSession {

    private static final long serialVersionUID = 1L;

    public WinRmSession(String host, String username, String password, WinRmPowerShellTerminal psTerminal) throws PowerShellException {
        super(host, username, password, psTerminal);
    }
